...
select 고객번호, 담당자명, 마일리지 as 포인트 from 고객; /*AS='별칭' 대소문자 구분 없음(DB안에서만)*/
...
select * from 고객 order by 마일리지 desc limit 3; /*마일리지가 많은 고객부터 상위 3명의 고객 정보 조회 desc='내림차순' asc='오름차순'*/
